...
$data = array(
    ...
    'medium squarefree composites and primes' => array(2,3,5,6,7,10,11,13,14,15,17,19,21,22,23,26,29,30),
...
function exercise_phi_simple_compute($data) {
  $n = randomElement($data['medium squarefree composites and primes']);
...
function wrapXML($link, $exercise_solution) {
  return
      '<sheaf title="BU CAS CS 235 Fall 2015">'
